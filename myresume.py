...
class Professor(db.Model):
    ...
    courses = db.relationship('Course', backref='professor', cascade='cascade'
...
def courses():
    courses = [
        ['MISY350', 'Web Design',
         'Learning about Web Development, using full stack coding'],
        ['BUAD470', 'Sales Management and Selling',
            'Learn the sales process'],
        ['MISY430', 'Systems Analysis and Design',
         'Learning how to design systems using BPM tools']
    ]
...
def add_courses():
    ...
    if request.method == 'POST':
        ...
        course = Course
        (course_number=course_number, title=title, description=description)
